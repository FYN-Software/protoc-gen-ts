...
import { getTypeReferenceExpr } from '../../type.js';
...
{
    return factory.createTypeReferenceNode(getTypeReferenceExpr(rootDescriptor, methodDescriptor.input_type) as Identifier);
}
